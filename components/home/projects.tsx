...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      <p className="section-title-sm seq">پروژه ها</p>
      <br></br>
      <h2 className="text-xl md:max-w-3xl w-full seq max-w-sm mt-2">
        بیش از ۱۰۰ پروژه عمرانی انجام شده در سال های اخیر 
      </h2>
    </div>
  );
