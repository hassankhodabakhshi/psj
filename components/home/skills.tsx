...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      <p className="section-title-sm seq">خدمات</p>
      <h1 className="section-heading seq mt-2">خدمات شرکت </h1>
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
      ما در خانواده پارسین سازه جنوب با در اختیار داشتن تیم های اجرایی، برنامه ریزی و کنترل پروژه نسب به ارایه خدمات کامل و جامع در زمینه احداث، بازسازی، خرید و فروش مصالح و اجاره تجهیزات و ماشین آلات مرتبط در حوزه راهسازی، زیربنایی، صنعتی، شهرسازی، مسکونی، اداری، تجاری و … فعالیت داریم.{" "}
      </h2>
    </div>
  );
